...
pub fn resolve_rule(parsed: &ParsedClass, tokens: &TokenRegistry) -> Option<RuleMatch> {
    let declarations = match (parsed.family, parsed.utility.as_str(), parsed.value.as_deref()) {
        ...
        (Family::Fluent, "action", Some("primary")) => vec![
            token_declaration("font-family", tokens.fluent.typography.get("font-family")?),
            token_declaration("font-size", tokens.fluent.typography.get("label-size")?),
            token_declaration("font-weight", tokens.fluent.typography.get("label-weight")?),
        ...
        (Family::Material, "action", Some("primary")) => vec![
            token_declaration("font-family", tokens.material.typography.get("font-family")?),
            token_declaration("font-size", tokens.material.typography.get("label-size")?),
            token_declaration("font-weight", tokens.material.typography.get("label-weight")?),
            declaration("line-height", "1"),
        ...
        (Family::Material, "action", Some("tonal")) => vec![
            token_declaration("font-family", tokens.material.typography.get("font-family")?),
            token_declaration("font-size", tokens.material.typography.get("label-size")?),
            token_declaration("font-weight", tokens.material.typography.get("label-weight")?),
            declaration("line-height", "1"),
